    ...
    <main className="h-screen grid grid-cols-2 relative">
      <div className="relative w-full flex flex-col bg-muted p-10 text-primary-foreground">
        ...
        <blockquote className="space-y-2 ">
          <p className="text-lg">
            &ldquo;VisionForge is a game changer for me. I have been able to generate high-quality professional headshots within minutes. It has saved me countless hours of work and cost as well.&rdquo;
          </p>
          <footer className="text-sm">Sahil T.</footer>
        </blockquote>
      </div>
      </div>

        <div className="relative flex flex-col left-[12%] items-center justify-center p-8 h-full max-w-xl w-full" >
          <div className='w-[350px] max-auto'>
        <AuthForm />
      </div>
      </div>
